...
_id_12F61( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_1 scripts\mp\utility\game::_id_12D6( "passive_berserk" ) || var_1 scripts\mp\utility\game::_id_12D6( "passive_berserk_silent" ) )
...
handlespecialistpassive( var_0, var_1 )
{
    ...
    if ( var_0.pers["passive_mini_specialist_key"] >= 14 && !var_0 scripts\mp\utility\game::_id_12D6( "passive_nuke" ) )
    {
