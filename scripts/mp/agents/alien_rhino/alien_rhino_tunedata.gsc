...
setupmytunedata( var_0 )
{
    ...
    var_0.charge_attack_damage_amt = 180;
    var_0.charge_attack_damage_radius_sq = 900;
    var_0.charge_attack_stop_facing_enemy_dist_sq = 40000;
    var_0.max_charge_time_ms = 5000;
    ...
    var_0.initial_taunt_wait_time_ms = 5000;
    var_0.min_time_between_taunts_ms = 15000;
    var_0.max_time_between_taunts_ms = 20000;
    var_0.taunt_chance = 100;
    var_0.taunt_min_dist_to_enemy_sq = 90000;
    var_0.taunt_max_dist_to_enemy_sq = 90000;
    var_0.min_time_between_melee_attacks_ms = 1000;
    var_0.small_slam_radius = 150;
    var_0.small_slam_max_damage = 90;
    var_0.small_slam_min_damage = 90;
    var_0.big_slam_radius = 150;
    var_0.big_slam_max_damage = 180;
    var_0.big_slam_min_damage = 180;
    ...
    var_0.min_leap_distance_sq = 129600;
