...
_id_DF0C()
{
    ...
    level._id_18EE["generic_zombie"]["asm"] = "zombie_dlc2";
    level._id_18EE["generic_zombie"]["behaviorTree"] = "zombie_dlc2";
    level._id_18EE["generic_zombie"]["animclass"] = "zombie_dlc2_animclass";
    level._id_13BDC = 1;
    level._id_4878 = 0;
    level._id_BF7C = 0;
    level._id_BCCE = [];
...
_id_FAB0()
{
    ...
    level.agent_funcs["generic_zombie"]["on_damaged_finished"] = _id_0F72::_id_C5CE;
