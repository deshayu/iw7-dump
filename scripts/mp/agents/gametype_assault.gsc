...
_id_F8DF()
{
    ...
    var_0 = 0;
    botzonesetteam( level._id_4B19, game["defenders"] );
}
...
_id_2E6E()
{
    ...
    for (;;)
    {
        ...
        if ( level._id_2C5C )
        {
            if ( distancesquared( self.origin, level._id_F014.origin ) > squared( level._id_DAA3 * 2 ) )
            {
        ...
        if ( level._id_2C5C && isdefined( level._id_2C44 ) && self._id_E67C != "bomb_defuser" )
        {
