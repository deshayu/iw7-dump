...
onnormaldeath( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_1._id_AA08 ) && var_1._id_AA08 )
        var_1 thread scripts\mp\utility\game::_id_83B4( "last_man_kill" );
    ...
    else if ( var_0._id_9DBC )
    {
        ...
        scripts\mp\utility\game::_id_F79E( 13, var_1.team, var_1 getentitynumber() );
        var_1 scripts\mp\utility\game::incperstat( "defends", 1 );
        var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
...
_id_8378()
{
    ...
    scripts\mp\utility\game::_id_F79E( 16, self.team, self getentitynumber() );
...
_id_C50D( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1 ) && !scripts\mp\gameobjects::_id_9E07( var_1.pers["team"] ) )
    {
