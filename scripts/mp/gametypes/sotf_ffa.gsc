...
onstartgametype()
{
    ...
    scripts\mp\utility\game::setobjectivetext( "allies", var_0 );
    scripts\mp\utility\game::setobjectivetext( "axis", var_0 );

    if ( level._id_10A56 )
    {
        scripts\mp\utility\game::setobjectivescoretext( "allies", var_0 );
        scripts\mp\utility\game::setobjectivescoretext( "axis", var_0 );
    }
    else
    {
        scripts\mp\utility\game::setobjectivescoretext( "allies", var_1 );
        scripts\mp\utility\game::setobjectivescoretext( "axis", var_1 );
    }

    scripts\mp\utility\game::setobjectivehinttext( "allies", var_2 );
    scripts\mp\utility\game::setobjectivehinttext( "axis", var_2 );
    _id_98CE();
    var_3 = [];
...
onspawnplayer()
{
    ...
    if ( !isdefined( self._id_68BC ) )
    {
        self._id_68BC = scripts\mp\rank::getscoreinfovalue( "kill" );
        scripts\mp\utility\game::setextrascore0( self._id_68BC );
    }
...
{
    var_1.assists = var_1 scripts\mp\utility\game::getpersstat( "longestStreak" );
        ...
        else
        {
            while ( isalive( var_2 ) )
            {
                if ( level._id_61C0 )
                {
                    ...
                    level thread _id_1011A( "sotf_crates_incoming" );
                    wait( var_1 );
                    continue;
                }
...
_id_1044A( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self._id_485F == "sotf_weapon" && var_3 == getdvarint( "scr_sotf_ffa_crategunamount", 1 ) )
...
_id_F674( var_0 )
{
    ...
    for ( var_2 = 0; var_2 < var_1.size; var_2++ )
    {
        ...
        level._id_13CA7["sum"] = level._id_13CA7["sum"] + var_1[var_2]["weight"];
