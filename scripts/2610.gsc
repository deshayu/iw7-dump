    ...
    if ( _id_32E0( "." ) )
    {
        if ( var_1 )
        {
            if ( level._id_11B7._id_D2C7 < 190 )
                ...
                level._id_11B7._id_D2C7 = level._id_11B7._id_D2C7 + 10;
        }
        else
            level._id_11B7._id_D2C7 = level._id_11B7._id_D2C7 + 5;
...
_id_B934()
{
    ...
    {
        if ( var_0 )
            level._id_11B7._id_DCE1 = level._id_11B7._id_DCE1 + 1;
        else if ( var_1 )
        {
            if ( level._id_11B7._id_DCE1 < 1 )
                level._id_11B7._id_DCE1 = 1;
            else
                level._id_11B7._id_DCE1 = level._id_11B7._id_DCE1 + 10;
        }
        else
            level._id_11B7._id_DCE1 = level._id_11B7._id_DCE1 + 0.1;
    }
    else if ( _id_32DF( "-" ) )
    {
        if ( var_0 )
...
_id_119CC()
{
    level._id_11B7._id_10386 = level._id_11B7._id_10386 + 1;
...
_id_663E()
{
    ...
    for (;;)
    {
        self._id_11763 = self._id_11763 * 0.85;
        self._id_11763 = self._id_11763 - 0.05;
...
_id_663F()
{
    ...
    {
        self._id_11763 = self._id_11763 + 0.05;
        self._id_11763 = self._id_11763 * 1.25;
...
_id_7C49()
{
    ...
    if ( _id_32EE( "kp_uparrow", "DPAD_UP" ) )
    {
        ...
        level._id_F1BC = level._id_F1BC + var_6;
    }
    ...
    if ( _id_32EE( "kp_rightarrow", "DPAD_RIGHT" ) )
    {
        ...
        level._id_F1BD = level._id_F1BD + var_6;
    }
    ...
    if ( _id_32EE( "BUTTON_Y" ) )
    {
        ...
        level._id_F1BE = level._id_F1BE + var_6;
    }
    ...
    var_7 = ( 0, 0, 0 );
    var_7 = var_7 + var_3 * level._id_F1BC;
    var_7 = var_7 + var_2 * level._id_F1BD;
    var_7 = var_7 + var_4 * level._id_F1BE;
    return var_7;
}
