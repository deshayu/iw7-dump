...
_id_108F2( var_0 )
{
    ...
    if ( scripts\mp\analyticslog::_id_1E6A() && !var_0 )
    {
        if ( scripts\mp\analyticslog::_id_1E5E() )
            level._id_10841 = level._id_10841 + 1;
        else
...
recordsegmentdata( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_0._id_F18B["distanceTotal"] = var_0._id_F18B["distanceTotal"] + distance2d( var_0.savedsegmentposition, var_0.origin );
        var_0.savedsegmentposition = var_0.origin;
...
_id_1853()
{
    level._id_AD8D[self.team] = level._id_AD8D[self.team] + self.pers["lives"];
}
