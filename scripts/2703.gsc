...
_id_97E0( var_0 )
{
    ...
    level._id_37A8._id_3CAA[0].origin = level._id_37A8._id_3CAA[0].origin + anglestoleft( level._id_37A8._id_3CAA[0].angles ) * 6.0;
    level._id_37A8._id_3CAA[2].origin = level._id_37A8._id_3CAA[2].origin + anglestoleft( level._id_37A8._id_3CAA[2].angles ) * 20.0;
    level._id_37A8._id_3CAA[1].origin = level._id_37A8._id_3CAA[1].origin + anglestoleft( level._id_37A8._id_3CAA[1].angles ) * 12.0;
    level._id_37A8._id_3CAA[4].origin = level._id_37A8._id_3CAA[4].origin + anglestoleft( level._id_37A8._id_3CAA[4].angles ) * 6.0;
    level._id_37A8._id_3CAA[3].origin = level._id_37A8._id_3CAA[3].origin + anglestoright( level._id_37A8._id_3CAA[3].angles ) * 0.0;
    level._id_37A8._id_3CAA[5].origin = level._id_37A8._id_3CAA[5].origin + anglestoleft( level._id_37A8._id_3CAA[5].angles ) * 18.0;
    level._id_37A8._id_3CAA[4].origin = level._id_37A8._id_3CAA[4].origin + anglestoforward( level._id_37A8._id_3CAA[4].angles ) * -46.0;
    level._id_37A8._id_3CAA[3].origin = level._id_37A8._id_3CAA[3].origin + anglestoforward( level._id_37A8._id_3CAA[3].angles ) * -46.0;
    level._id_37A8._id_3CAA[5].origin = level._id_37A8._id_3CAA[5].origin + anglestoforward( level._id_37A8._id_3CAA[5].angles ) * -46.0;
