...
_id_4BD7( var_0 )
{
    ...
    if ( isdefined( level._id_8DD3 ) )
        var_1 = var_1 + level._id_8DD3.size;

    if ( isdefined( level._id_AD8B ) )
        var_1 = var_1 + level._id_AD8B.size;

    if ( isdefined( level._id_12B14 ) )
        var_1 = var_1 + level._id_12B14.size;
...
_id_93FA( var_0 )
{
    if ( !isdefined( var_0 ) )
        ...
        level._id_6BAA = level._id_6BAA + var_0;
}
...
_id_1824( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
        self._id_EC52[var_0][var_2] = self._id_EC52[var_0][var_2] + var_1;
    else
        self._id_EC51[var_0] = self._id_EC51[var_0] + var_1;
}
...
_id_B93D( var_0, var_1, var_2 )
{
    ...
    var_4 = 0;
    var_4 = var_4 + scripts\mp\supers\super_amplify::_id_1E58( var_3 );
