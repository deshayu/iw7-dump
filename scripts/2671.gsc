...
_id_11AF4( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_1._id_C944 = 0;
        level _id_0A76::_id_5CF6( var_1.origin, var_1, "kill_50", 1, undefined, 1 );
    }
}
...
set_player_stealthed()
{
    ...
    playfx( level._effect["stimulus_glow_burst"], scripts\engine\utility::_id_5D14( self.origin ) - ( 0, 0, 30 ) );
    scripts\engine\utility::_id_CE2B( "zmb_fnf_stimulus", scripts\engine\utility::_id_5D14( self.origin ) );
...
dolocaloverkilldamage( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_10 = scripts\engine\utility::_id_782F( var_2.origin, level._id_1084F, [ var_2 ], undefined, 64, 1 );

    foreach ( var_12 in var_10 )
        var_12 _meth_80B0( var_2.maxhealth, var_2.origin, var_1, var_1, "MOD_EXPLOSIVE", "iw7_walkietalkie_zm" );
}
...
updatepassivefiredamage( var_0, var_1, var_2 )
{
    ...
    {
        if ( _id_0A77::_id_80D8( var_0._id_6D53 ) == _id_0A77::_id_80D8( var_1 ) )
            var_2 thread _id_0A77::_id_4D0D( var_2, var_0, 5, var_6, "MOD_HEAD_SHOT", "incendiary_ammo_mp", undefined, "burning" );
    }
}
...
updatepassivecolddamage( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.cold_weapon ) )
    {
        ...
        {
            var_2 thread unsetslowmovementaftertime( var_2, var_2._id_01F5 );
...
unsetslowmovementaftertime( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        var_0._id_01F5 = var_1;
        var_0 scripts\asm\asm_bb::_id_2968( var_1 );
    }
}
