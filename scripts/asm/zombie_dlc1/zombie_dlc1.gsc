...
_id_2AD0()
{
    if ( isdefined( level._id_119E["zombie_dlc1"] ) )
        return;

    var_0 = spawnstruct();
    var_0._id_1581 = [];
    var_0._id_1581[0] = _id_0C2B::_id_98E5;
    var_0._id_1581[1] = scripts\aitypes\zombie_dlc1\behaviors::checkscripteddlc1;
    ...
    var_0._id_1581[6] = ::zombie_dlc1fn0;
    ...
    var_0._id_1581[11] = scripts\aitypes\zombie_dlc1\behaviors::chaseenemydlc1;
    var_0._id_1581[12] = scripts\aitypes\zombie_dlc1\behaviors::seekenemydlc1;
    var_0._id_1581[13] = _id_0C2B::_id_C0B6;
    level._id_119E["zombie_dlc1"] = var_0;
}

_id_DEE8()
{
    _id_2AD0();
    _func_2D8( "zombie_dlc1" );
}
