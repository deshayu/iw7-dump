...
_id_10168( var_0, var_1, var_2, var_3, var_4, var_5, var_2, var_6 )
{
    return 0;
}
...
{
    if ( isdefined( self._id_9E0C ) && !issubstr( self.agent_type, "alien" ) )
    {
        self._id_C026 = 1;
...
_id_C4BD( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( self._id_9B81 ) || isdefined( var_1 ) && isdefined( var_4 ) && var_4 == "incendiary_ammo_mp" )
        ...
        self._id_2C09 setscriptablepartstate( "electrocuted", "active", 1 );
