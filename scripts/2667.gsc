...
_id_B9EC()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0._id_13C2E ) )
        {
            ...
            if ( issubstr( var_0._id_13C2E, "iw7_venomx_zm" ) )
            {
                if ( isdefined( level.venom_x_weapon_logic_thread ) )
                    level thread [[ level.venom_x_weapon_logic_thread ]]( var_0 );
            }
        }
    }
}
...
_id_385F( var_0, var_1 )
{
    ...
    if ( var_2 == "dischord" || var_2 == "facemelter" || var_2 == "headcutter" || var_2 == "shredder" )
    {
        ...
        {
            if ( isdefined( self._id_C8A2[var_2] ) && self._id_C8A2[var_2]._id_B111 == 2 )
                return 0;
            else
                return 1;
        }
...
_id_13BA8()
{
    ...
    for (;;)
    {
        ...
        if ( _id_0A77::_id_9C42( var_0 ) || issubstr( var_0, "fists" ) || issubstr( var_0, "heart" ) || issubstr( var_0, "dagger" ) )
            continue;
        ...
        if ( var_1 == 0 && ( var_0 != "iw7_cpbasketball_mp" && var_0 != "none" ) )
        {
            ...
            {
                _id_0A6A::_id_12885( "venx_nag_eggs", "zmb_comment_vo", "low", 3, 0, 0, 0, 20 );
                continue;
            }
