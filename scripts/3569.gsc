...
_id_BB7F( var_0, var_1 )
{
    ...
    for ( var_13 = physics_createcontents( [ "physicscontents_solid", "physicscontents_structural", "physicscontents_canshootclip", "physicscontents_missileclip" ] ); var_10 <= var_0 + var_1 && !var_2._id_437E; var_10 = var_10 + var_1 )
    {
        var_12 = var_11;
