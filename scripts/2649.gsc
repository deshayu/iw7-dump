...
_id_9C64( var_0, var_1, var_2 )
{
    ...
    if ( !scripts\engine\utility::within_fov( var_0.origin, var_0 getplayerangles(), var_4, cos( 25 ) ) )
        return 0;
...
_id_12E34( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) && interaction_is_sliding_door( var_3 ) && scripts\engine\utility::_id_9CEE( var_3.player_opened ) )
        var_1 = 0;
...
_id_F422( var_0, var_1 )
{
    ...
    if ( var_1.script_noteworthy == "weapon_purchase" && isdefined( self.weapon_purchase_looking_at ) )
    {
        if ( scripts\cp\zombies\direct_boss_fight::is_kung_fu( self.weapon_purchase_looking_at.weaponname ) )
            self._id_9A3F _meth_852E( scripts\cp\zombies\direct_boss_fight::get_kung_fu_string( self.weapon_purchase_looking_at.weaponname ) );
        else
        {
            var_3 = _id_8228( self.weapon_purchase_looking_at.weaponname );
            self._id_9A3F _meth_852E( var_3, int( scripts\cp\zombies\direct_boss_fight::get_weapon_cost( self.weapon_purchase_looking_at.weaponname ) ) );
        }
    }
    else if ( _id_9A28( var_1 ) )
    {
        if ( isdefined( var_2 ) && !isstring( var_2 ) && var_2 == &"COOP_INTERACTIONS_PURCHASE_AMMO" )
        {
            var_4 = _id_0A77::_id_80D8( var_1.script_noteworthy );
            var_5 = _id_0A6B::_id_7D62( var_4 );
            var_3 = _id_8228( var_1.script_noteworthy );

            if ( var_5 > 1 )
                self._id_9A3F _meth_852E( int( 4500 ), var_3 );
            else
                self._id_9A3F _meth_852E( int( 0.5 * level._id_9A43[var_1.script_noteworthy]._id_46A2 ), var_3 );
        }
    }
...
_id_C00C()
{
    ...
    for (;;)
    {
        level waittill( "player_accessed_nonpowered_interaction", var_0, var_1 );

        if ( _id_0A77::map_check( 4 ) )
        {
            if ( issubstr( var_1.script_noteworthy, "_trap" ) )
                var_0 thread _id_0A6A::_id_12885( "trap_not_avail", "zmb_comment_vo" );
            else
...
_id_4616()
{
    ...
    for (;;)
    {
        level waittill( "player_accessed_interaction_on_cooldown", var_0, var_1 );

        if ( _id_0A77::map_check( 4 ) )
        {
            if ( issubstr( var_1.script_noteworthy, "_trap" ) )
                var_0 thread _id_0A6A::_id_12885( "trap_cooldown", "zmb_comment_vo" );
            else
...
_id_9A33( var_0 )
{
    ...
    {
        if ( ![[ level.should_post_activate_delay_func ]]( var_0 ) )
            return;
    }
...
_id_383E( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_1 ) )
        var_4 = var_1;
    else if ( interaction_is_sliding_door( var_0 ) )
        var_4 = 0;
    else
    ...
    for (;;)
    {
        ...
        switch ( var_0 )
        {
            case "wall_buy":
                ...
                {
                    if ( isdefined( var_1.script_noteworthy ) && var_1.script_noteworthy == "iw7_venomx_zm" )
                    {
...
_id_9A27( var_0, var_1 )
{
    ...
    if ( isdefined( var_0._id_4622 ) )
    {
        level notify( "player_accessed_interaction_on_cooldown", var_1, var_0 );
        return 0;
    }
...
interaction_is_sliding_door( var_0 )
{
    return isdefined( var_0.script_noteworthy ) && ( var_0.script_noteworthy == "facility_sliding_door_750" || var_0.script_noteworthy == "facility_sliding_door_1000" || var_0.script_noteworthy == "facility_sliding_door_1250" || var_0.script_noteworthy == "facility_sliding_door_1500" || var_0.script_noteworthy == "facility_sliding_door_2000" );
}
...
_id_3867( var_0 )
{
    if ( _id_0A77::_id_8BBE( var_0._id_CA4C ) )
        ...
        return 0;
    else if ( isdefined( self._id_13FA4 ) && self._id_13FA4.size > 4 && !scripts\engine\utility::_id_9CEE( self.have_permanent_perks ) )
        return 0;
