...
_id_B07C()
{
    ...
    for ( var_1 = 0; var_1 < 5; var_1++ )
    {
        ...
        wait 0.5;
        var_2 = _id_7AB9( self );
        var_3 = scripts\engine\utility::_id_7ECB( var_2 );

        if ( !isdefined( var_3 ) )
            continue;

        self._id_7542 = spawnfx( var_3, self.origin + ( 0, 0, 50 ) );
...
{
    if ( isdefined( level.temporal_increase ) )
        var_0 thread _id_D73B( 30 * level.temporal_increase, "fire_30" );
    else
...
_id_20AB( var_0 )
{
    ...
    if ( isdefined( level.temporal_increase ) )
        var_0 thread _id_D73B( 30 * level.temporal_increase, "grenade_30" );
    else
...
_id_20AA( var_0 )
{
    ...
    if ( isdefined( level.temporal_increase ) )
        var_0 thread _id_D73B( 20 * level.temporal_increase, "infinite_20" );
    else
...
give_max_ammo_to_player( var_0 )
{
    ...
    {
        if ( var_0._id_D782[var_8]._id_10307 == "secondary" )
            continue;

        var_0 thread _id_DDD1( var_8 );
    }
}
...
_id_20AC( var_0 )
{
    ...
    if ( isdefined( level.temporal_increase ) )
        var_0 thread _id_D73B( 30 * level.temporal_increase, "instakill_30" );
    else
...
_id_EBA5( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( level.temporal_increase ) )
        level thread _id_4DCD( var_1, 30 * level.temporal_increase, var_2 );
    else
...
_id_20A3( var_0 )
{
    ...
    if ( isdefined( level.temporal_increase ) )
        var_0 thread _id_D73B( 30 * level.temporal_increase, "cash_2" );
    else
