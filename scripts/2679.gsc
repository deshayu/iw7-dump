...
issprintenabled()
{
    return !isdefined( self._id_55E1 ) || !self._id_55E1;
}

isweaponfireenabled()
{
    return !isdefined( self._id_55C8 ) || !self._id_55C8;
}
...
_id_9CEB( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) && scripts\engine\utility::_id_9CEE( var_2.fridge_trap_marked ) )
        return 1;
...
_id_CF90( var_0, var_1, var_2, var_3, var_4 )
{
    self endon( "disconnect" );
    ...
    self._id_CF90.x = 0;
    self._id_CF90.y = 0;
    self._id_CF90 setshader( var_5, 640, 480 );
...
_id_E2D5( var_0 )
{
    ...
    foreach ( var_3 in self._id_4643 )
    {
        if ( !self hasweapon( var_3 ) )
        {
            ...
            self giveweapon( _id_0A6B::_id_E469( var_3, undefined, var_6, undefined, var_7 ), -1, 0, -1, 1 );
        }
        ...
        {
            var_8 = spawnstruct();
            var_8._id_B111 = self._id_464C[var_3];
            self._id_C8A2[_id_80D8( var_3 )] = var_8;
        }
    }

    var_10 = self._id_464B;

    if ( !isdefined( var_10 ) || var_10 == "none" )
    {
        foreach ( var_12 in self._id_4643 )
        {
            if ( _id_0A6B::_id_9D75( var_12 ) )
            {
                var_10 = var_12;
                break;
            }
        ...
        if ( var_5 < 3 )
        {
            ...
            if ( !self hasweapon( var_3 ) )
            {
                ...
                else
                {
                    ...
                    self giveweapon( _id_0A6B::_id_E469( var_3, undefined, var_8, undefined, var_7 ), -1, 0, -1, 1 );
                }
            }
            ...
            {
                var_9 = spawnstruct();
                var_9._id_B111 = self._id_464C[var_3];
                self._id_C8A2[_id_80D8( var_3 )] = var_9;
            }
...
_id_D222( var_0 )
{
        ...
        if ( isdefined( var_0.agent_type ) )
        {
            switch ( var_0.agent_type )
            {
                ...
                case "zombie_clown":
                    ...
                    break;
                case "alien_rhino":
                    var_3 = scripts\engine\utility::_id_DC6B( [ "injured_pain_rhino1", "injured_pain_rhino2", "injured_pain_rhino3" ] );
                    break;
                case "alien_phantom":
                case "alien_goon":
    ...
    if ( self._id_134FD == "p6_" && var_3 == "injured_pain_clown" )
...
_id_80E3( var_0 )
{
    ...
    {
        if ( _id_9BA0( "faster_health_regen_upgrade" ) || isdefined( level.purify_active ) && level.purify_active >= 1 )
        {
            var_0._id_1615 = 0.45;
