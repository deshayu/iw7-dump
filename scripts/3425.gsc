...
_id_5CF7( var_0, var_1, var_2 )
{
    ...
    {
        level thread _id_0A76::_id_5CF6( var_1, var_2, level._id_726C, undefined, undefined, 1 );
...
_id_1B99( var_0 )
{
    ...
    {
        self [[ level.clown_spawn_fx_func ]]( var_0 );
        return;
    }
...
deactivate_volume_by_name( var_0 )
{
    if ( isdefined( level._id_10816[var_0] ) )
        level._id_10816[var_0] _id_B292();
}

_id_B291()
{
    if ( isdefined( self._id_0019 ) && self._id_0019 )
        return;
    ...
    for (;;)
    {
        ...
        if ( level._id_13BD3 > 2 )
        {
            if ( isdefined( level.final_wave_vo_func ) )
                level thread [[ level.final_wave_vo_func ]]( level._id_13BD3 );
        }
...
_id_13BC6( var_0 )
{
    if ( !_id_0A61::_id_3837() )
    {
        ...
        {
            foreach ( var_2 in level.players )
                var_2 thread _id_0A6A::_id_12885( "convo_deja_vu", "zmb_comment_vo", "highest", 666, 0, 0, 0, 100 );
        }
    }
