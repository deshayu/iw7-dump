...
_id_6952()
{
    ...
    if ( is_valid_spawn_weapon( self._id_AA45 ) )
...
_id_13701( var_0, var_1, var_2 )
{
    ...
    if ( !var_1 )
    {
        ...
        else if ( !scripts\engine\utility::_id_6E34( "meph_fight" ) || scripts\engine\utility::_id_6E34( "meph_fight" ) && !scripts\engine\utility::_id_6E25( "meph_fight" ) )
            _id_F44B( self, var_3 );
        else
            var_3 = undefined;
    }
...
{
    if ( scripts\engine\utility::_id_9CEE( var_0.hasentanglerequipped ) )
        return;
...
_id_1420( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        if ( scripts\engine\utility::array_contains( var_0, var_3 ) )
            continue;
        else if ( !_id_0A77::_id_9F7C( var_3, "alt_" ) )
