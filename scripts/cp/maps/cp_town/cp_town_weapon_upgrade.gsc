...
_id_13C62( var_0, var_1 )
{
    ...
    if ( scripts\engine\utility::_id_9CEE( level.has_picked_up_fuses ) && !isdefined( level.placed_alien_fuses ) )
    {
        ...
        var_1 thread _id_0A6A::_id_12885( "pap_place_fuse", "town_comment_vo", "low", 10, 0, 0, 1, 100 );
    ...
    if ( var_1 _id_385F( var_4 ) )
    {
        ...
        if ( var_1 _id_0A77::_id_9D05() )
        {
            ...
            var_1 _id_0A5E::_id_D9AD( "mt_dlc3_upgrade_weapons" );
        }
...
play_pap_vo( var_0 )
{
    var_0 thread _id_0A6A::_id_12885( "weapon_pap", "rave_pap_vo", "high" );
}
