...
cp_town_onzombiedamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    var_12 = self;
    ...
    var_14 = scripts\engine\utility::_id_9CEE( var_12.hit_by_dodging_player );
    var_15 = var_4 == "MOD_MELEE";
    var_16 = scripts\engine\utility::_id_9CEE( var_1._id_98F3 );
    var_17 = scripts\engine\utility::_id_9CEE( var_12._id_9CDD );
    var_3 = var_3 | 4;
    var_18 = isdefined( var_1 ) && isplayer( var_1 );
    var_19 = scripts\engine\utility::_id_9D74( var_4 ) || var_4 == "MOD_EXPLOSIVE_BULLET" && var_8 != "none";
    var_20 = var_19 && _id_0A77::isheadshot( var_5, var_8, var_4, var_1 );
    var_21 = scripts\engine\utility::_id_9CEE( self._id_28E0 );
    var_22 = scripts\engine\utility::_id_9CEE( level._id_9925 ) && !_id_0A77::agentisinstakillimmune();
    var_23 = var_4 == "MOD_EXPLOSIVE_BULLET" && ( isdefined( var_8 ) && var_8 == "none" ) || var_4 == "MOD_EXPLOSIVE" || var_4 == "MOD_GRENADE_SPLASH" || var_4 == "MOD_PROJECTILE" || var_4 == "MOD_PROJECTILE_SPLASH";
    var_24 = !var_16 && var_20 && var_19 && var_1 _id_0A77::_id_9BA0( "headshot_explosion" );
    var_25 = var_15 && var_1 _id_0A77::_id_9BA0( "increased_melee_damage" );
    var_26 = var_15 && var_1 _id_0A77::_id_9BA0( "shock_melee_upgrade" );
    var_27 = _id_0A77::_id_9D3E( var_5 );
    var_28 = _id_0A77::agentisfnfimmune();
    var_29 = _id_0A77::agentisinstakillimmune();
    var_30 = var_18 && var_1 _id_0A77::_id_8BBE( "perk_machine_change" );
    var_31 = _id_0A77::agentisspecialzombie();
    ...
    if ( var_18 && !var_28 )
    {
        ...
        if ( scripts\engine\utility::_id_9CEE( var_1.stimulus_active ) )
        {
            ...
            foreach ( var_34 in level.players )
            {
                if ( var_34 == var_1 )
                {
                    if ( distance2dsquared( var_34.origin, self.origin ) <= 10000 )
                    {
                        playfx( level._effect["stimulus_glow_burst"], self gettagorigin( "j_spineupper" ) );
                        playfx( level._effect["stimulus_shield"], var_34 gettagorigin( "tag_eye" ), anglestoforward( var_34.angles ), anglestoup( var_34.angles ), var_34 );

                        if ( var_2 >= self.health )
                        {
                            if ( scripts\engine\utility::_id_9CEE( var_34._id_98F3 ) )
                                _id_0D59::revive_downed_entities( var_34 );
                        }

                        if ( var_34.health + var_2 / ( level.players.size + 1 ) >= var_34.maxhealth )
                            var_34.health = var_34.maxhealth;
                        else
                            var_34.health = int( var_34.health + var_2 / ( level.players.size + 1 ) );
                    }
                ...
                {
                    playfx( level._effect["stimulus_glow_burst"], self gettagorigin( "j_spineupper" ) );
                    playfx( level._effect["stimulus_shield"], var_34 gettagorigin( "tag_eye" ) );
                    ...
                    if ( int( var_34.health + var_2 / ( level.players.size + 1 ) ) >= var_34.maxhealth )
                    {
                        var_34.health = var_34.maxhealth;
                        continue;
                    }
    ...
    if ( !var_15 && _id_0CBC::checkaltmodestatus( var_5 ) && var_18 && !isdefined( var_1._id_AD2C ) && var_1 _id_0A77::_id_9BA0( "sniper_soft_upgrade" ) )
        var_36 = var_1 _id_0A77::_id_4626( var_5 ) == "weapon_sniper";

    var_37 = !var_28 && scripts\engine\utility::_id_9CEE( level._id_69FA ) && isdefined( var_4 ) && var_4 == "MOD_UNKNOWN";
    var_38 = isdefined( var_5 ) && var_5 == "iw7_knife_zm_cleaver" && iscrog( self );

    if ( isdefined( var_5 ) && var_5 == "iw7_knife_zm_cleaver" && !iscrog( self ) )
        _id_0A77::add_to_notify_queue( "cleaver_damage_zombie" );

    var_39 = !var_29 && ( var_21 || var_22 || var_38 || var_26 || var_37 || var_24 || var_25 || var_36 );
    var_40 = scripts\engine\utility::_id_9CEE( self._id_9E0C );
    var_41 = var_18 && var_15 && var_1._id_4BF5 == "iw7_knife_zm_cleaver";

    if ( var_41 )
    {
        if ( scripts\engine\utility::_id_9CEE( self.glowing ) && var_2 >= self.health )
        {
    ...
    if ( var_39 && !var_28 )
    {
        ...
        if ( var_26 )
        {
            ...
            var_1 thread _id_0D4A::_id_11193( self geteye(), self, self.maxhealth, "MOD_UNKNOWN", undefined, var_26 );
        }
    ...
    else
    {
        ...
        var_42 = level._id_13BD3;
        var_43 = _id_0CBC::_id_9BF7( var_5, var_4 );
        var_44 = scripts\engine\utility::_id_9CEE( self._id_9B81 ) && !var_19;
        var_45 = var_20 && var_1 _id_0A77::_id_9BA0( "sharp_shooter_upgrade" );
        var_46 = var_19 && var_1 _id_0A77::_id_9BA0( "bonus_damage_on_last_bullets" );
        var_47 = var_19 && var_1 _id_0A77::_id_9BA0( "damage_booster_upgrade" );
        var_48 = var_19 && isdefined( var_1.special_ammo_weapon ) && var_1.special_ammo_weapon == var_5;
        var_49 = var_18 && var_1 _id_0A77::_id_8BBE( "perk_machine_boom" );
        var_50 = var_18 && var_1 _id_0A77::_id_8BBE( "perk_machine_smack" );
        ...
        var_54 = var_20 && var_19 && var_1 _id_0A6B::_id_8BD1( var_5, "highcal" );

        if ( issubstr( var_5, "cutie" ) && var_18 )
        {
            var_55 = 7000;
        ...
        if ( var_19 && scripts\engine\utility::_id_9CEE( var_1._id_DF50 ) )
            var_2 = var_2 * 2;
    ...
    if ( isdefined( var_1._id_CA2F ) && var_1._id_CA2F["damagemod"]._id_3237 == 2.0 && var_19 )
        var_2 = var_2 * 1.33;
    ...
    var_2 = _id_0CBC::_id_6BA4( self, var_5, var_2, 0, var_31, 0, 0 );

    if ( isdefined( var_1.special_zombie_damage ) && var_31 )
    ...
    if ( iscrog( self ) && isdefined( level.special_zombie_damage_func ) && isdefined( level.special_zombie_damage_func[self.agent_type] ) )
        var_2 = self [[ level.special_zombie_damage_func[self.agent_type] ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 );
...
cp_town_onzombiekilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( getweaponbasename( var_4 ) == "iw7_cutie_zm" || getweaponbasename( var_4 ) == "iw7_cutier_zm" && scripts\engine\utility::_id_9CEE( self.affectedbyfovdamage ) )
    {
...
callback_townzombieplayerdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    var_12 = self;
    ...
    var_20 = var_19 && isdefined( var_1.agent_type ) && var_1.agent_type == "generic_zombie";
    ...
    if ( var_12 _id_0A77::_id_9BA0( "secret_service" ) && isalive( var_1 ) )
    {
        ...
        if ( isdefined( var_1.agent_type ) && ( var_1.agent_type == "crab_mini" || var_1.agent_type == "crab_brute" || var_1 _id_0A77::agentisfnfimmune() ) )
            var_31 = 0;
...
crog_processdamagefeedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
