...
rave_vo_callouts( var_0 )
{
    ...
    level._id_134DC["rave_kevin_smith_dialogue_vo"] = ::one_to_one_dialogue_vo_handler;
    level._id_134DC["rave_ks_vo"] = ::ks_vo_handler;
...
one_to_one_dialogue_vo_handler( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    _id_0A6A::_id_F60C( 1 );
    var_10 = _id_0A61::_id_7DD2( var_0, var_9 );
    ...
    else
    {
        foreach ( var_12 in var_10 )
        {
            ...
            if ( var_9 && isdefined( level._id_134B4[var_12]._id_54AA ) )
            {
            ...
            {
                if ( isdefined( var_14 ) && var_8._id_134FD == var_14 || var_13 || getdvarint( "scr_solo_dialogue", 0 ) == 1 )
                {
                    var_17 = _id_0A6A::_id_4978( var_15, var_3, var_5, var_6 );
                    var_8 _id_0A6A::_id_F60D( 1 );
                    var_8 _id_0A6A::_id_F60B( var_17 );
                    var_8 _id_0A6A::_id_CE77( var_17 );
                    var_8 _id_0A6A::_id_C9B8( var_17 );
...
_id_13E0C( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    foreach ( var_9 in level.players )
    {
        ...
        var_9 thread _id_0A6A::_id_CE8B( var_10, var_7 );
    }
...
_id_CC8F( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    level._id_2001 = 1;
    ...
    foreach ( var_10 in level.players )
    {
        ...
        if ( isdefined( var_8 ) && var_10._id_134FD == var_8 )
        {
            var_11 = var_8 + var_0;
        ...
        {
            var_12 = _id_0A6A::_id_4978( var_0, var_3, var_5, var_6 );
            var_10 thread _id_0A6A::_id_CE8B( var_12 );
        }
    }
        ...
        if ( isdefined( var_1._id_134FD ) )
        {
            switch ( var_1._id_134FD )
            {
                case "p1_":
                    if ( randomint( 100 ) > 50 )
                    {
                        level thread _id_0A6A::_id_12885( "spawn_team_1_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                        level._id_4481["spawn_team_1_1"] = 1;
                    }
                    else
                    {
                        level thread _id_0A6A::_id_12885( "spawn_cabin_20_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                        level._id_4481["spawn_cabin_20_1"] = 1;
                    }
                ...
                case "p4_":
                    if ( randomint( 100 ) > 50 )
                    {
                        level thread _id_0A6A::_id_12885( "spawn_alt_2_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                        level._id_4481["spawn_alt_2_1"] = 1;
                    }
                    else
                    {
                        level thread _id_0A6A::_id_12885( "spawn_alt_3_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                        level._id_4481["spawn_alt_3_1"] = 1;
                    }
                ...
                case "p3_":
                    if ( randomint( 100 ) > 50 )
                    {
                        level thread _id_0A6A::_id_12885( "spawn_alt_4_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                        level._id_4481["spawn_alt_4_1"] = 1;
                    }
                    else
                    {
                        level thread _id_0A6A::_id_12885( "spawn_cabin_18_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                        level._id_4481["spawn_cabin_18_1"] = 1;
                    }
                ...
                case "p2_":
                    if ( randomint( 100 ) > 50 )
                    {
                        level thread _id_0A6A::_id_12885( "spawn_alt_5_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                        level._id_4481["spawn_alt_5_1"] = 1;
                    }
                    else
                    {
                        level thread _id_0A6A::_id_12885( "spawn_cabin_19_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                        level._id_4481["spawn_cabin_19_1"] = 1;
                    }
...
multiple_kevinsmith_intro_vo( var_0 )
{
    ...
    {
        case 1:
            var_0 thread _id_0A6A::_id_12885( "spawn_team_first", "rave_comment_vo" );
            break;
        case 2:
            var_0 thread _id_0A6A::_id_12885( "extra_ksmith_2", "rave_comment_vo" );
            break;
        case 3:
            var_0 thread _id_0A6A::_id_12885( "extra_ksmith_3", "rave_comment_vo" );
            break;
        case 4:
            var_0 thread _id_0A6A::_id_12885( "extra_ksmith_4", "rave_comment_vo" );
            break;
        default:
            break;
    }
...
play_ks_vo( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( self == level )
    {
        foreach ( var_9 in level.players )
        {
            ...
            {
                if ( isdefined( level.boat_survivor ) )
                    scripts\engine\utility::_id_CE2B( var_0, level.boat_survivor.origin, 0, level.boat_survivor );
                else
                    scripts\engine\utility::_id_CE2B( var_0, level.survivor.origin, 0, level.survivor );
    ...
    else
    {
        ...
        else if ( isplayer( self ) )
        {
            if ( isdefined( self._id_134FD ) )
                thread _id_0A6A::_id_CE8B( var_7 );
        }
