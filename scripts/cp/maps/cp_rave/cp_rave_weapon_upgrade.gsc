...
_id_13C62( var_0, var_1 )
{
    ...
    if ( var_1 _id_385F( var_4 ) )
    {
        ...
        if ( var_11 )
            var_21 = rave_getoffsetfrombaseweaponname( var_14 );
        else
            var_21 = rave_getoffsetfrombaseweaponname( var_19 );

        level thread _id_DF48( var_1, var_20, var_0 );
        level notify( "pap_used", var_1, var_6, var_19 );
        var_20 makeunusable();
        var_1 thread rave_playpapgesture( var_1, var_1.pap_gesture, var_7, var_4, var_14 );
        ...
        if ( var_5 == "dischord" || var_5 == "facemelter" || var_5 == "headcutter" || var_5 == "shredder" )
...
rave_playpapgesture( var_0, var_1, var_2, var_3, var_4 )
{
...
rave_getoffsetfrombaseweaponname( var_0 )
{
...
cp_rave_pap_machine_func( var_0, var_1 )
{
...
update_level_pap_machines( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_7 in level.player_pap_machines )
    {
        ...
        if ( scripts\engine\utility::_id_9CEE( var_7.owner.has_zis_soul_key ) && var_5 || scripts\engine\utility::_id_9CEE( level.placed_alien_fuses ) && var_5 )
        {
...
get_pap_offhand_weapon( var_0, var_1 )
{
    ...
    {
        if ( !issubstr( var_1, var_4 ) && ( !_id_0A77::_id_9F7C( var_4, "alt_" ) && !issubstr( var_4, "knife" ) ) )
            return var_4;
    }
...
process_pap_stat_logging( var_0, var_1 )
{
    ...
    var_1 _id_0D2A::_id_12D7C( "PUMP_IT_UP", 1 );
}
