...
listen_for_tent_door_open()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 == "drive_in_theater" || var_0 == "drive_in_elvira" )
            break;
    }
...
update_crog_spawners()
{
    ...
    var_1 = [ "morgue", "supermarket" ];

    foreach ( var_3 in level._id_8457 )
    {
        if ( !isdefined( var_3._id_13538 ) )
            continue;

        if ( !isdefined( var_3._id_13538._id_28AB ) )
            continue;

        foreach ( var_5 in var_1 )
        {
            if ( var_3._id_13538._id_28AB == var_5 )
            {
                level._id_8457 = scripts\engine\utility::array_remove( level._id_8457, var_3 );
                var_3._id_13538._id_8457 = scripts\engine\utility::array_remove( var_3._id_13538._id_8457, var_3 );
            }
        }
...
brute_goon_summon()
{
    level endon( "force_spawn_wave_done" );
    level endon( "game_ended" );
    var_0 = get_num_guys_to_brute_spawn();
    var_0 = min( self._id_108FB.size, var_0 );
    _id_0D61::_id_93EB( var_0 );
    wait 1;
    brute_goon_spawn_loop( var_0 );
    _id_0D61::_id_4FB8( var_0 );
}
...
get_num_guys_to_brute_spawn()
{
    ...
    var_0 = min( var_0, level.players.size + 1 );
    ...
    if ( var_0 <= 0 )
    {
        ...
        {
            if ( isdefined( var_4.agent_type ) && var_4.agent_type == "generic_zombie" )
                var_2++;
        }
...
brute_goon_spawn_loop( var_0 )
{
    ...
    {
        var_2 = get_spawner_and_spawn_goons( 1 );
        wait 0.1;
    }
}
...
get_spawner_and_spawn_goons( var_0 )
{
    ...
    var_2 = min( var_0, 1 );
    spawn_goons_from_eggs( var_2 );
    return var_2;
}

spawn_goons_from_eggs( var_0 )
{
    var_1 = 0.3;
    var_2 = 0.7;
    ...
    if ( var_0 > 0 )
    {
        ...
        for ( var_4 = 0; var_4 < var_0; var_5._id_93A8 = 0 )
        {
            var_5 = _id_0D61::_id_7C2E();
            var_5._id_93A8 = 1;
            var_5.lastspawntime = gettime();
            var_6 = _id_10719( var_5 );
...
dbg_spawn_goons( var_0, var_1 )
{
    ...
    if ( var_4 > 0 )
    {
        _id_0D61::_id_93E6( var_4 );
        var_5 = [];

        for ( var_6 = 0; var_6 < var_4; var_7._id_93A8 = 0 )
        {
            var_7 = undefined;
            var_8 = level._id_8457;
            var_7 = _id_0D61::_id_8456( var_8 );
            ...
            var_7._id_13538 _id_0D61::_id_B291();
            level thread _id_0A77::_id_5B85( var_7.origin, 20, 3, ( 0, 1, 0 ) );
            var_7._id_93A8 = 1;
            var_7.lastspawntime = gettime();
            var_13 = _id_10719( var_7 );
...
_id_10719( var_0 )
{
    var_1 = var_0.origin;
    var_2 = var_0.angles;
    var_3 = get_fake_crab_boss_spawner();

    if ( isdefined( level.crab_boss ) )
    {
        var_4 = level.agenttunedata["crab_boss"].egg_sack_launching_tags;
        var_5 = scripts\engine\utility::_id_22A7( var_4 );
        var_6 = randomint( var_5.size );
        var_7 = level.crab_boss;
        var_3 = var_7 gettagorigin( var_5[var_6] );
    }

    var_8 = launch_egg_sac( var_3, var_1, 7, 1, var_2 );
    var_9 = "crab_mini";

    if ( isdefined( var_8 ) )
    {
        update_respawn_data( var_9 );
...
{
    var_0 = [ ( 4492, 6602, -257 ), ( 3362, 6854, -257 ), ( 4292, 6602, -257 ), ( 3362, 6654, -257 ) ];
...
{
    var_5 = "cp_town_temp_egg_sac_green";
    var_1 = getclosestpointonnavmesh( var_1 );
    var_6 = spawn( "script_model", var_0 );
    var_6 setmodel( var_5 );
    var_6 playsound( "boss_crog_fire_egg_launch" );
    var_6 thread scripts\cp\maps\cp_town\cp_town_crab_boss_escort::egg_sac_or_bomb_incoming_delayed( var_2 );
    var_6 thread egg_sac_damage_monitor( var_6, var_3 );
    var_6 thread egg_sac_fly( var_6, var_0, var_1, var_2, var_3, var_4 );
    return var_6;
}
...
egg_sac_damage_monitor( var_0, var_1 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) )
    {
        ...
        level._id_4B6E = level._id_4B6E + 1;
    }

    _id_0D61::_id_4FB6( 1 );
    scripts\cp\maps\cp_town\cp_town_crab_boss_escort::play_damage_explosion_fx( var_0, var_1 );
    scripts\cp\maps\cp_town\cp_town_crab_boss_escort::delete_egg_sac( var_0 );
}
...
egg_sac_fly( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_6 = 386.09;
    scripts\engine\utility::waitframe();
    scripts\cp\maps\cp_town\cp_town_crab_boss_escort::show_flying_trail( var_0, var_4 );
    var_7 = var_6 * ( 0, 0, -1 );
...
{
    scripts\cp\maps\cp_town\cp_town_crab_boss_escort::_id_577E( var_1 );
    scripts\cp\maps\cp_town\cp_town_crab_boss_escort::_id_57B2( var_0, var_1 );
    scripts\cp\maps\cp_town\cp_town_crab_boss_escort::play_landing_explosion( var_1, var_2 );
    scripts\cp\maps\cp_town\cp_town_crab_boss_escort::hide_flying_trail( var_0 );
    scripts\cp\maps\cp_town\cp_town_crab_boss_escort::hide_landing_marker( var_0 );
    var_4 = var_0 egg_sac_spawn( var_0, var_1, var_3 );
    return var_4;
}
...
egg_sac_spawn( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp\maps\cp_town\cp_town_crab_boss_escort::make_egg_sac_spawner( var_1, var_2 );
    var_4 = var_3 _id_0D61::_id_1081B( "crab_mini", 1, var_3 );

    if ( isdefined( var_4 ) )
    {
        adjust_crab_mini_health( var_4 );
        var_4 thread crab_mini_audio_monitor();
    }

    _id_0D61::_id_4FB6( 1 );
    thread scripts\cp\maps\cp_town\cp_town_crab_boss_escort::delete_egg_sac( var_0 );
    return var_4;
}

adjust_crab_mini_health( var_0 )
{
    var_0.health = scripts\mp\agents\crab_mini\crab_mini_agent::calculatecrabminihealth();
}
...
crab_mini_audio_monitor()
{
    ...
    for (;;)
    {
        ...
        {
            case "attack_hit":
                level thread _id_0D62::_id_CE9C( self, "alert", 0 );
                break;
            case "attack_miss":
                level thread _id_0D62::_id_CE9C( self, "alert", 0 );
                break;
    ...
    if ( var_0 >= 10 && var_0 <= 16 )
    {
        if ( randomint( 100 ) > 60 )
        {
            ...
            if ( isdefined( var_1._id_134FD ) )
            {
                ...
                {
                    case "p1_":
                        if ( !isdefined( level._id_4481["sally_end_round_10_16_1"] ) )
                        {
                            var_1 thread _id_0A6A::_id_12885( "sally_end_round_10_16_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                            level._id_4481["sally_end_round_10_16_1"] = 1;
                        }

                        break;
                    case "p4_":
                        if ( !isdefined( level._id_4481["aj_end_round_10_16_1"] ) )
                        {
                            var_1 thread _id_0A6A::_id_12885( "aj_end_round_10_16_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                            level._id_4481["aj_end_round_10_16_1"] = 1;
                        }

                        break;
                    case "p3_":
                        if ( !isdefined( level._id_4481["andre_end_round_10_16_1"] ) )
                        {
                            var_1 thread _id_0A6A::_id_12885( "andre_end_round_10_16_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                            level._id_4481["andre_end_round_10_16_1"] = 1;
                        }

                        break;
                    case "p2_":
                        if ( !isdefined( level._id_4481["pdex_end_round_10_16_1"] ) )
                        {
                            var_1 thread _id_0A6A::_id_12885( "pdex_end_round_10_16_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                            level._id_4481["pdex_end_round_10_16_1"] = 1;
                        }
...
boss_spawn_vo()
{
    if ( scripts\engine\utility::_id_6E25( "elvira_summoned" ) || isdefined( level.elvira_ai ) )
        level thread _id_0A6A::_id_12885( "ww_crog_spawn_elvira", "rave_announcer_vo", "highest", 70, 0, 0, 1 );

    var_0 = _id_0A6A::_id_7C76( "ww_crog_spawn_elvira3" );
    var_1 = scripts\engine\utility::_id_DC6B( level.players );
    ...
    if ( isdefined( var_1._id_134FD ) )
    {
        ...
        {
            case "p1_":
                level thread _id_0A6A::_id_12885( "sally_boss_first_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                break;
            case "p2_":
                level thread _id_0A6A::_id_12885( "pdex_boss_first_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                break;
            case "p3_":
                level thread _id_0A6A::_id_12885( "andre_boss_first_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                break;
            case "p4_":
                level thread _id_0A6A::_id_12885( "aj_boss_first_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100 );
                break;
            default:
                break;
        }
...
cp_town_boss_spawn()
{
    ...
    var_0 thread _id_0D61::killplayersifonhead( var_0 );
    return 1;
}
