...
init()
{
    ...
    var_0._id_B91A = "cp_town_mind_control_device";
    var_0._id_B924 = "cp_town_mind_control_device_good";
    var_0._id_B925 = "cp_town_mind_control_device_bad";
...
give_crafted_mindcontrol_trap( var_0, var_1 )
{
    ...
    _id_0A77::_id_F313( "crafted_mindcontrol", ::give_crafted_mindcontrol_trap, var_1 );
}
...
set_carrying_mindcontrol( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        if ( var_3 == "cancel_ims" || var_3 == "force_cancel_placement" || var_3 == "player_action_slot_restart" )
        {
            ...
            var_0 mindcontrol_trap_setcancelled( var_3 == "force_cancel_placement" && !isdefined( var_0._id_6DEC ) );
...
create_mindcontrol_trap( var_0, var_1 )
{
    ...
    var_4 setmodel( level.mindcontrol_trap_settings[var_3]._id_B91A );
    var_4._id_EB9C = 3;
    ...
    var_4._id_10085 = 0;
    var_4._id_8E5A = 0;
    var_4._id_451C = level.mindcontrol_trap_settings[var_3];
    var_4 thread mindcontrol_trap_handleuse();

    if ( isdefined( var_1 ) )
        var_4 thread _id_0A77::_id_A030( var_1 );
    else
        var_4 thread _id_0A77::_id_A030( undefined, level.mindcontrol_trap_settings[self.mindcontrol_trap_type]._id_AC71 );
...
mindcontrol_trap_handleuse()
{
    ...
    for (;;)
    {
        ...
        var_0 thread set_carrying_mindcontrol( var_1, 0, self._id_AC71 );
        self delete();
        break;
    }
}
...
mindcontrol_trap_setcarried( var_0 )
{
    ...
    self._id_3A9D = var_0;
    var_0._id_9D81 = 1;
    var_0 thread _id_0A77::_id_12E3F( self, self.carried_mindcontrol_trap, level.mindcontrol_trap_settings["crafted_mindcontrol"] );
...
mindcontrol_trap_setactive()
{
    ...
    self sethintstring( level.mindcontrol_trap_settings[self.mindcontrol_trap_type]._id_017B );
    _id_0A77::_id_1861();
    var_0 = self.owner;
    var_0 _meth_80F3();
    ...
    thread _id_0A77::_id_A021( "mindcontrol_disconnect" );
...
{
    self endon( "death" );
    self._id_5761 = spawn( "trigger_radius", self.origin, 0, 200, 64 );
    ...
    for (;;)
    {
        ...
        {
            if ( !var_3 istouching( self._id_5761 ) )
                continue;

            if ( !_id_0A77::_id_FF18( var_3 ) || scripts\engine\utility::_id_9CEE( var_3.controlled ) || scripts\engine\utility::_id_9CEE( var_3._id_152C ) || scripts\engine\utility::_id_9CEE( var_3._id_9BB0 ) )
                continue;
...
control_zombie( var_0 )
{
    ...
    self._id_9CEF = 1;
    self._id_B57A = int( _id_0D61::_id_3728( "generic_zombie" ) * 0.5 );
    ...
    self._id_9CEF = undefined;
    self._id_B57A = undefined;
    self.controlled = 0;
    self.team = "axis";
    self._id_01F5 = self.og_movemode;
    self._id_015C = self.goalradius_old;
...
kill_intersecting_zombies( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = scripts\engine\utility::_id_7E2E( self.origin, var_2 );

        if ( distancesquared( var_3.origin, self.origin ) < var_1 )
        {
            var_3._id_74B5 = 1;
            var_3._id_4C87 = 1;
            var_3 _meth_80B0( var_3.health + 100, var_3.origin, self, self, "MOD_MELEE", "none" );

            if ( isdefined( var_0.owner ) )
                var_0.owner _id_0A5E::_id_D9AD( "mt_dlc3_crafted_kills" );
        }
