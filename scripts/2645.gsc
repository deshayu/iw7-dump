...
_id_8135( var_0, var_1 )
{
    ...
    else
    {
        ...
        var_2 = scripts\engine\utility::ter_op( scripts\engine\utility::_id_9CEE( level.disable_start_spawn_on_navmesh ), scripts\engine\utility::_id_5D14( var_3.origin, 0, -100 ), getclosestpointonnavmesh( var_3.origin ) );
