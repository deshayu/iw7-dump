...
_id_375A( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    if ( var_12 _id_0A77::_id_9BA0( "secret_service" ) && isalive( var_1 ) )
    {
        ...
        if ( isdefined( var_1.agent_type ) && ( var_1.agent_type != "generic_zombie" || !scripts\engine\utility::_id_9CEE( var_1._id_6622 ) ) )
            var_30 = 0;
...
{
    if ( scripts\engine\utility::_id_9CEE( level.disableplayerdamage ) )
        return 0;
