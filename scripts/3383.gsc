...
{
    if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) && should_play_upgraded_magic_wheel_vfx() )
        return "upgrade";

    if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap2 ) && should_play_upgraded_magic_wheel_vfx() )
        return "upgrade";
...
should_play_upgraded_magic_wheel_vfx()
{
    ...
    {
        case "cp_disco":
            if ( scripts\engine\utility::_id_9CEE( level.complete_skull_buster ) )
                return 1;
            else
                return 0;
        default:
...
_id_1010C( var_0, var_1 )
{
    ...
    if ( level.script == "cp_disco" )
    {
        if ( scripts\engine\utility::_id_9CEE( var_1.finished_backstory ) && !scripts\engine\utility::_id_9CEE( var_1.given_nunchucks ) )
        {
            ...
            if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap2 ) )
            {
                var_0._id_13C25 = scripts\engine\utility::_id_2279( var_0._id_13C25, "iw7_nunchucks_zm_pap2" );
                var_3 = "iw7_nunchucks_zm_pap2";
            }
            else if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) && !var_1 _id_0A77::_id_9BA0( "magic_wheel_upgrade" ) )
            {
        ...
        else if ( randomint( 100 ) > 95 || getdvar( "debug_gns_reward" ) != "" )
        {
            if ( !has_nunchucks_in_loadout( var_1 ) && ( scripts\cp\zombies\directors_cut::directors_cut_is_activated() || can_have_nunchucks( var_1 ) ) )
            {
                ...
                {
                    if ( var_1 _id_0A77::_id_9BA0( "magic_wheel_upgrade" ) && scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) )
                    {
                        var_3 = "iw7_nunchucks_zm_pap2";
                        var_0._id_13C25 = scripts\engine\utility::_id_2279( var_0._id_13C25, var_3 );
                    }
                    else
                        var_3 = "iw7_nunchucks_zm_pap1";
                }
    ...
    if ( level.script == "cp_final" )
    {
        if ( randomint( 100 ) > 95 )
        {
            if ( !has_venomx_in_loadout( var_1 ) && ( scripts\cp\zombies\directors_cut::directors_cut_is_activated() || can_have_venomx( var_1 ) ) )
            {
                ...
                if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap2 ) )
                {
                    var_0._id_13C25 = scripts\engine\utility::_id_2279( var_0._id_13C25, "iw7_venomx_zm_pap2+camo34" );
                    var_3 = "iw7_venomx_zm_pap2+camo34";
                }
                else if ( scripts\cp\zombies\directors_cut::directors_cut_is_activated() )
                {
                    if ( var_1 _id_0A77::_id_9BA0( "magic_wheel_upgrade" ) )
                        var_3 = "iw7_venomx_zm_pap2+camo34";
                    else
                ...
                {
                    var_3 = "iw7_venomx_zm_pap1+camo32";
                    var_0._id_13C25 = scripts\engine\utility::_id_2279( var_0._id_13C25, "iw7_venomx_zm_pap1+camo32" );
                }
                else if ( !scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) && var_1 _id_0A77::_id_9BA0( "magic_wheel_upgrade" ) )
                    var_3 = "iw7_venomx_zm_pap1+camo32";
                else if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) && var_1 _id_0A77::_id_9BA0( "magic_wheel_upgrade" ) )
                ...
                {
                    var_0._id_13C25 = scripts\engine\utility::_id_2279( var_0._id_13C25, "iw7_venomx_zm" );
                    var_0._id_BF6D = "iw7_venomx_zm";
                }
            }
        }
    }
    ...
    if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) || scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap2 ) )
    {
    ...
    if ( isdefined( var_1 ) && isplayer( var_1 ) && scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) || scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap2 ) )
...
_id_1360B( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 _meth_81AE() || var_1 meleebuttonpressed() || scripts\engine\utility::_id_9CEE( var_1._id_9FCB ) )
            continue;
    ...
    else
    {
        ...
        switch ( var_3 )
        {
            ...
            case "sdflmg":
            case "mauler":
                var_1 thread _id_0A6A::_id_12885( "magicwheel_weapon", "zmb_comment_vo", "low", 10, 0, 1, 0, 25 );
                break;
            case "katana":
                var_1 thread _id_0A6A::_id_12885( "magicwheel_katana", "zmb_comment_vo", "low", 10, 0, 1, 0 );
                break;
            case "venomx":
                var_1 thread _id_0A6A::_id_12885( "magicwheel_venx", "zmb_comment_vo", "low", 10, 0, 1, 1, 50 );
                break;
            case "nunchucks":
            ...
            case "glprox":
            case "chargeshot":
                var_1 thread _id_0A6A::_id_12885( "magicwheel_weapon", "zmb_comment_vo", "low", 10, 0, 1, 0, 40 );
                break;
            case "cheytac":
            case "kbs":
                var_1 thread _id_0A6A::_id_12885( "magicwheel_weapon", "zmb_comment_vo", "low", 10, 0, 1, 0, 40 );
...
_id_B16A( var_0, var_1 )
{
    ...
    if ( issubstr( var_1, "gauss_" ) )
        var_0 _id_0A5E::_id_D9AD( "mt_gauss_unlock" );

    if ( issubstr( var_1, "mag_" ) )
        var_0 _id_0A5E::_id_D9AD( "mt_mag_unlock" );

    if ( issubstr( var_1, "unsalmg_" ) )
        var_0 _id_0A5E::_id_D9AD( "mt_unsalmg_unlock" );

    if ( issubstr( var_1, "tacburst_" ) )
        var_0 _id_0A5E::_id_D9AD( "mt_tacburst_unlock" );
...
get_camo_for_upgraded_weapon( var_0, var_1 )
{
    ...
    if ( isdefined( level.no_pap_camos ) && scripts\engine\utility::array_contains( level.no_pap_camos, var_0 ) )
        var_2 = undefined;
    else if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap2 ) && isdefined( level.pap_2_camo ) )
        var_2 = level.pap_2_camo;
    else if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) && var_1 _id_0A77::_id_9BA0( "magic_wheel_upgrade" ) && isdefined( level.pap_2_camo ) )
        var_2 = level.pap_2_camo;
...
get_attachment_for_upgraded_weapon( var_0, var_1 )
{
    ...
    if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) && var_1 _id_0A77::_id_9BA0( "magic_wheel_upgrade" ) )
        return "pap2";
...
is_magic_wheel_upgrades( var_0 )
{
    ...
    if ( scripts\engine\utility::_id_9CEE( level.magic_wheel_upgraded_pap1 ) )
        return 1;
...
_id_10C4D( var_0, var_1, var_2 )
{
    ...
    foreach ( var_8 in level.players )
    {
        ...
        {
            var_8 thread _id_0A76::_id_D73B( 30 * level.temporal_increase, "fire_30" );
            continue;
        }
